...
class ModelTrainerConfig:
    ...
    trained_model_path= os.path.join(ARTIFACTS_DIR,"model.pkl" )
...
class ModelTrainer:
    ...
    def finetune_best_model(self,
        ...
        try:
            ...
            model_param_grid = self.utils.read_yaml_file(self.model_trainer_config.model_config_file_path)["models"][best_model_name]
